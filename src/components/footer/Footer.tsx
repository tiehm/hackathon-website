  ...
  render() {
    return <div
      ...
      <div className={'flex flex-col xl:flex-row xl:flex-wrap ' +
          'xl:justify-center xl:items-center xl:py-10'}>

        {/* container for the contact person image and the llt
            logo, on desktop this also holds the contact
            information */}
        <div className={'container mx-auto flex flex-row items-center ' +
            'text-center justify-center py-4 gap-12 md:justify-between ' +
            'md:w-4/5 xl:w-1/2 xl:flex-row-reverse'}>

          <div className="flex flex-row justify-center  items-center gap-4">

            {/* the container for the contact person image is needed as
             flexbox does weird height align stuff otherwise */}
            <div className="flex justify-center items-center">

              {/* #contact-person holds the person who is in charge of
                  support/contacting as a background image */}
              <div
                id={'contact-person'}
          ...
          {/* container for the ltt logo, due to flexbox we need this
              container as the height would be all kinds of funky otherwise */}
          <div>
            {/* conditionally render the white or black ltt logo depending
                on the background color of the footer */}
        ...
        {/* contact details for mobile as the formatting is so different
            that we need to render the element elsewhere than on desktop */}
        <ContactDetails
          className={'w-4/5 text-left mx-auto flex-grow lg:hidden'}/>

      </div>

      <div className={'pt-14 pb-6 text-center text-text-s flex flex-col ' +
