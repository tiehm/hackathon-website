...
export class ShortInfo extends React.Component {
    ...
    render () {
        return <div className="font-semi-bold mt-16 md:text-head-m md:font-regular md:ml-auto tabletL:w-9/12 lg:w-8/12 lg:text-head-m 2xl:text-head-l">
            ...
            <CustomLink to="/event" className="bg-blue-12 text-blue-1 rounded text-center px-8 py-5 mt-12 ml-auto w-fit block cursor-pointer md:px-12 md:py-8 md:text-head-m" >
                Mehr erfahren!
            </CustomLink>
