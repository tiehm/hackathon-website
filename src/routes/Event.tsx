        ...
        <div className="overflow-x-hidden">
            <div className="flex flex-col">
                <div className="pt-8 flex-grow mb-6 lg:mb-0 mt-20 tabletL:mt-24 xl:mt-28 relative">
                    ...
                    <div className="lg:w-4/5 lg:mx-auto md:mt-10 py-6 pl-8 pr-10 tabletL:px-12">
                        ...
                        <div className="bg-blue-3 font-semi-bold text-text-caption rounded border-[1px] w-fit py-6 px-8 border-blue-12 uppercase ml-auto mt-16">
                            Anmeldung möglich ab 01.10.2022
                        </div>
                    </div>
                </div>
            </div>
            <div id="page-four" className="relative flex flex-col mt-10">
