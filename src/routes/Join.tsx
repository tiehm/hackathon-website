        ...
        return (<div className="overflow-x-hidden">
            <div className="h-screen flex flex-col">
                <div className="bg-red-3 w-full flex justify-center align-middle items-center h-full mb-10 flex-grow select-none">
                    <div>
                        <div className="font-medium text-blue-12 text-[80px] leading-[80px] lg:text-[140px] lg:leading-[140px] text-center">
                            Coming soon!
                        </div>
                        <div className="text-text-caption text-blue-12 font-semi-bold sm:float-right uppercase text-center">
                            (ab 01.10.2022)
                        </div>
                    </div>
                </div>
